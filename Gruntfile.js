// Generated on 2016-02-10 using generator-angular-fullstack 3.2.0
'use strict';
...
module.exports = function(grunt) {
  ...
  grunt.registerTask('reminders', function() {
    ...
    parse(csvData, {}, function(err, output) {
      ...
      if (
        reminders[0][0] == expectedHeader[0] &&
        reminders[0][1] == expectedHeader[1] &&
        reminders[0][2] == expectedHeader[2] &&
        ...
        console.log('Error.');
        throw 'Reminders not compiled. Csv header is not the expected format.'
        done();
      }
    })
